  ...
  <div>
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="myNavbar">
          <ul class="nav navbar-nav navbar-right">
            <li><a href="perfilpaciente2.php">Editar perfil</a></li>
    ...
    <div class="container-fluid text-center">
      <div class="container-fluid bg-grey" style="margin-top: 30px;">
        ...
        <h2 class="col-sm-12" style="text-align: center;"><strong>Mi Perfil Paciente</strong></h2>
        ...
        <div class="col-sm-6" style="text-align: left;">
          ...
          <h4><strong>Religión: </strong><?php echo $est['Religion'];?></h4>
        </div> 
