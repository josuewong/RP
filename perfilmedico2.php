...
if (isset($_GET['logout']))
  ...
  if (isset($_POST['actualizarinfor'])) {
    ...
    $resultadow = $conecta-> actualizarmedico($nom1,$nom2,$ap1,$ap2,$genero,$fechaM,$direc,$tell,$esp,$correo,$pass,$tipous,$idmedico);
    header("location: perfilmedico1.php");
  }
...
<body>
  <div>
    ...
    <!-- Editando Perfil -->
    <form action="perfilmedico2.php" method="POST">
    <div class="container-fluid text-center" style="margin-top: 50px;">
      <div class="container-fluid bg-grey">
        <div class="content-text">
          <h2 class="col-sm-12" style="text-align: center;"><strong>Editando Mi Perfil Médico</strong></h2>
          ...
          <div class="row" style="margin-bottom: 10px;">
            ...
            <div class="col-sm-12">
              ...
              <input style="margin-bottom: 10px;" type="email" class="form-control" size="30"
          ...
          <div>
            ...
            <h5 style="text-align: left;">Tu Genero selecionado es:</h5>
              ...
              <div class="col-sm-3">
                ...
                <input id="tel" name="tel" style="margin-bottom: 10px;" type="text" class="form-control" size="30" value="<?php echo $est['Telefono'];?>">
              </div>
              

              <div class="col-sm-3">
                <h5 style="text-align: left;">Indica tu especialidad como médico</h5>
                <input id="espe" name="espe" style="margin-bottom: 10px;" type="text" class="form-control" size="30" value="<?php echo $est['NombreEspecialidad'];?>">
              </div>
            </div>

          </div>
          <button id="actualizarinfor" name="actualizarinfor" type="submit" class="btn btn-lg"
