...
-- Tiempo de generación: 30-11-2021 a las 05:01:17
...
-- Procedimientos
--
DROP PROCEDURE IF EXISTS `ActualizaConsulta`$$
CREATE DEFINER=`root`@`localhost` PROCEDURE `ActualizaConsulta` (IN `idConsultaIN` INT, IN `ClasificacionConsultaIN` VARCHAR(45), IN `DescripcionConsultaIN` VARCHAR(255), IN `FechaIN` DATE, IN `HoraIN` TIME, IN `IdeMedicoIN` INT)  begin
UPDATE consulta SET 
ClasificacionConsulta = ClasificacionConsultaIN, 
DescripcionConsulta = DescripcionConsultaIN, 
Fecha = FechaIN, 
Hora = HoraIN,
Medico_idMedico = IdeMedicoIN
WHERE (`idConsulta` = idConsultaIN);
...
DROP PROCEDURE IF EXISTS `ActualizarReceta`$$
CREATE DEFINER=`root`@`localhost` PROCEDURE `ActualizarReceta` (IN `TratamientoIN` VARCHAR(500), IN `CostoIN` INT, IN `Medico_idMedicoIN` INT, IN `idRecetaIN` INT)  begin
UPDATE receta SET 
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `EnviarReceta` (IN `TratamientoIN` VARCHAR(500), IN `CostoIN` INT, IN `IdMedico` INT, IN `idConsulta` INT, IN `idPaciente` INT)  BEGIN
...
CREATE TABLE IF NOT EXISTS `consulta` (
  ...
  `DescripcionConsulta` varchar(255) DEFAULT NULL,
...
(2, 'shfdhd', 'db', '2010-10-11', '10:11:00', 1, 1);
...
(5, 'jonathan18@gmail.com', '$2y$10$trIAbLX0i3zkYVe9PgZVWuWg4J1MV75xrrr3B2t2aYq8ICeL1kB6G', 1, 8),
(6, 'Ingrid@gmail.com', '$2y$10$vq5ASArTo.JYHDH82RqObuibLpa7NzJYqubfggVLqF.aSUIW0O4ka', 1, 9),
(7, 'jonathan@gmail.com', '$2y$10$HuOrKQv3FpZWyB06Kt.qOuzirOTSvVLlZqywmNtwHEZPKjehi8j8O', 1, 10),
(8, 'j@gmail.com', '$2y$10$H3enEOqTym47oTdU8TRE8OvFW9CMLco5wmJjmA16ZR0WVHN.1NRtW', 1, 11);
...
(2, 'juan123', '827ccb0eea8a706c4c34a16891f84e7b', 0, 2, 1),
(51, 'jonathan18@gmail.com', '81dc9bdb52d04dc20036dbd8313ed055', 0, 46, 1),
(52, 'jonathan12@gmail.com', '$2y$10$mYxGg9ihDttBQk/w/Tz8QORKZKt/QzWoZJtv4YjcOVYXKC/iylEUG', 0, 47, 1),
(54, 'jonathan11@gmail.com', '$2y$10$/dsQ2GbQWw8FY4ojvZPLfe1DYiY795.vdtuuheALsSR2iv/Rctn.W', 0, 49, 1);
...
(7, 'jonathan', 'josué', 'Wong', 'Velasquez', 'Hombre', '2000-12-18', 'managua', 77777777, 'Medicina'),
(8, 'jonathan', 'josué', 'Wong', 'Velasquez', 'Hombre', '2000-12-18', 'asdfghjkl', 0, ''),
(9, 'Ingrid', 'Fabiola', 'Ortiz', 'Lezama', 'Mujer', '2000-12-18', 'managua', 777777, 'Medicina'),
(10, 'jonathan', 'josué', 'Wong', 'Velasquez', 'Hombre', '2000-12-18', 'managua', 77777777, 'Medicina'),
(11, 'jonathan', 'josué', 'Wong', 'Velasquez', 'Hombre', '1222-02-15', 'thsrth', 47854111, 'dgf');
...
(1, 'Ana', 'Andrea', 'Lopez', 'Gomez', 'Hombre', '2222-12-12', 'thsrth', 77777777, 'xxxxxxx'),
(2, 'Juan', 'Antonio', 'Riveras', 'Montolla', 'Hombre', '1998-10-18', 'Managua,Laureles', 77777777, 'dfg'),
(46, 'jonathan', 'josué', 'Wong', 'Velasquez', 'Hombre', '2000-12-18', 'managua', 88888888, 'qwertyuiop'),
(47, 'ghsgh', 'josué', 'f', 'Velasquez', 'Hombre', '2000-12-18', 'thsrth', 88888888, 'qwertyuiop'),
(48, 'jonathan', 'josué', 'Wong', 'Velasquez', 'Hombre', '2000-12-18', 'thsrth', 6747647, 'dd'),
(49, 'jonathan', 'josué', 'Wong', 'Velasquez', 'Indica tu genero', '2000-12-18', 'asdfghjkl', 88888888, 'sdgb');
